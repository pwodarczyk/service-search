...
public class EmployeeProfile extends Fragment {
	...
	String str_experience,str_description;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		View view = LayoutInflater.from(getActivity()).inflate(R.layout.employee_profile,
				null);
...
//		imageLoader = new ImageLoader(getActivity());
		...
		try {
			...
			etexperiance.setText(result_experience);
			et_epm_discription.setText(result_description);
...
// Insert the fragment by replacing any existing fragment
		...
		btnUpdate.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				str_experience = etexperiance.getText().toString();
				str_description = et_epm_discription.getText().toString();
...
//                                publishProgress((int) ((num / (float) totalSize) * 100));
			...
			entity.addPart("experience", new StringBody(str_experience));
			entity.addPart("description", new StringBody(str_description));
